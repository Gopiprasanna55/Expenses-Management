...
export const REDIRECT_URI = process.env.AZURE_REDIRECT_URI || "http://localhost:5000/auth/redirect";
export const POST_LOGOUT_REDIRECT_URI = process.env.AZURE_POST_LOGOUT_REDIRECT_URI || "http://localhost:5000";
